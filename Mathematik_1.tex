...
% % TODO Vorlesung 19.10. erste Hälfte
...
\begin{description}
  \item[a) Doppelte Negation:] \hfill
  $A \equiv \neg(\neg A)$
  ...
  \begin{itemize}
    ...
    \item[] \attention gilt nicht für '$\Rightarrow$' !! ($A \Rightarrow B \not\equiv B \Rightarrow A$)
  \end{itemize}  
...
Beispiel: $\underset{A}{\text{Pit ist ein Dackel.}} \Rightarrow \underset{B}{\text{Pit ist ein Hund.}}$
...
\qquad Pit ist Hund. $\Rightarrow$ Pit ist Dackel.
